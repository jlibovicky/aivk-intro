\documentclass[handout,aspectratio=169,dvipsnames]{beamer}
...
\begin{frame}{Organizace předmětu}
    ...
    \begin{itemize}[<+->]
        ...
        \item Úvodní přednáška -- \texbf{teď}
...
\begin{frame}{Problémy učení z dat: Overfitting}
    ...
    \begin{itemize}
        ...
        \item<3-> Stereotypy můžou být pro model efektivní způsob optimalizace \\
            ...
            \visible<5->{
                \includegraphics<5->[width=350pt]{img/sexy_doctor.png} \\
...
\begin{frame}{Jazykové modely GPT}
    ...
    \begin{itemize}[<+->]
        ...
        \item GPT-3 je natrénovaný na 45TB textu (37 milionů Zločinů a trestů),
            ...
            \item GPT-3 je asi nejblíže populárním představám o AI, ale
...
\summary{Shrnutí}{%
    ...
    AI je leckde, Rada Evropy právě připravuje mezinárodní smlouvu o regulaci
    -- hodí se vědět, jak věci fungují
