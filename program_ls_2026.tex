\begin{frame}{Organizace předmětu}
    ...
    \begin{itemize}[<+->]
		...
		\item Seminář o obecných otázkách 9.4., Speciální seminář 14.5.
...
\begin{frame}{Program}
    ...
    26.2. & Rudolf Rosa: \hfill \textbf{AI a divadlo}  \\
	...
	26.3. & Karl Štěpánová (CIIRC ČVUT): \hfill \textbf{Adaptivní robotické systémy} \\
