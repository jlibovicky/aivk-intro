    ...
    \begin{itemize}
        ...
        \item<1-> Moderní pojetí inteligence jako jedné měřitelné veličiny vzniklo
            ...
            \begin{itemize}
                ...
                \item<2-> Chtěli lidi \emph{seřadit} -- nutně tedy jednodimenzionální škála

                \item<3-> IQ testy často sloužily jako nástroj k odůvodnění sociální nerovnosti
        ...
        \item<7-> Říct, že někdo nebo něco je ,,inteligentnější'', \textbf{nedává
            ...
            \begin{itemize}
                ...
                \item<9-> Šachový program poráží každého velmistra~-- je tedy ,,inteligentnější než člověk''?
